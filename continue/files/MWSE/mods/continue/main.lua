...
function modConfig.onCreate(container)
	...
	local header = pane:createLabel{ text = common.text.extensionName .. "\nv1.6" }
	...
	txt.wrapText = true
	txt.text = common.text.aboutText
	...
	creditsBlock:createLabel({ text = common.text.optionHideCreditsButtonText })
	...
	hideBlock:createLabel({ text = common.text.optionHideNewGameButtonText })
...
local function registerModConfig()
	mwse.registerModConfig(common.text.extensionModListName, modConfig)
end
